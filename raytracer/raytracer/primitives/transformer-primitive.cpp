...
Primitive raytracer::primitives::rotate_around_x(const math::Angle& angle, Primitive transformee)
{
	return transform(math::transformations::rotate_x(angle), transformee);
}

Primitive raytracer::primitives::rotate_around_z(const math::Angle& angle, Primitive transformee)
{
	return transform(math::transformations::rotate_z(angle), transformee);
}

Primitive raytracer::primitives::rotate_around_y(const math::Angle& angle, Primitive transformee)
{
