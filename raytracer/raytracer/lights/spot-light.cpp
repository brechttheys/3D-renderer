...
namespace
{
	...
	{
	public:
		SpotLight(const Point3D& position, const Point3D& direction, const Angle& angle, const imaging::Color& color)
...
LightSource raytracer::lights::spot(const Point3D& position, const Point3D& direction, const Angle& angle, const imaging::Color& color)
{
